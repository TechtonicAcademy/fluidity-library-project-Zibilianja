...
const { pathname } = useLocation();
    ...
    return (
        ...
        <div className ="dropdown__shown">
            <button className="click__dropdown" onClick={() => setDropOpen((prev) => !prev)}><i className="fa fa-bars header__dropdown"></i></button>
            
            <ul className={dropDown ? 'dropdown--hidden.active' : 'dropdown--hidden'}>
            <div className="dropdown__content">
                ...
                <li className="dropdown__link dropdown__addbook"><NavLink to='/addbook'>Add Book</NavLink></li>
                </div>
            </ul>
